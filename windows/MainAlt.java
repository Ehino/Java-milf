...
public class MainAlt extends JFrame{
	...
	public MainAlt(Altushka altushka){
		...
		super.setBounds(550, 250, 550, 500);
		...
		filterVacancies(container);
	}

	private void filterVacancies(Container container) {
		...
		List<String[]> AltVacancies = dbHandler.getFilterVacancies("Альтушка", true);
		if (AltVacancies.isEmpty()) {
			JLabel noVacanciesLabel = new JLabel("Для вас пока нету доступных вакансий");
		...
		scrollPane.setBounds(20, 290, 500, 340);
